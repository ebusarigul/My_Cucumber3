...
public class _09_TestRunnerParallel_ExtentReport extends AbstractTestNGCucumberTests {
    ...
    public static void writeExtentReport() {
        ExtentService.getInstance().setSystemInfo("User Name", "Ebubekir Sarıgül");
